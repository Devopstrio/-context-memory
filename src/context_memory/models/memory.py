...
class Memory(Base, UUIDMixin, TimestampMixin):
    ...
    session_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True, comment="Session identifier")
    ...
    is_deleted: Mapped[bool] = mapped_column(default=False, nullable=False, index=True, comment="Soft delete flag")
...
class MemoryEmbedding(Base, UUIDMixin):
    ...
    embedding_vector: Mapped[list[float]] = mapped_column(JSONB, nullable=False, comment="Vector embedding array")
    model_name: Mapped[str] = mapped_column(String(255), nullable=False, comment="Embedding model identifier")
    dimensions: Mapped[int] = mapped_column(Integer, nullable=False, comment="Embedding vector dimensions")
    model_version: Mapped[str] = mapped_column(String(50), nullable=False, comment="Embedding model version")
